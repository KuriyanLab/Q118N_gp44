...
1. There are files with variant counts for different experiments. The color "green" indicates variant is from "Active template" and "Red" indicated "Inactive Template." Counts for all the replicates are present here. Please look at files names and sheet names.
